...
For Rockchip EFUSE support need to add to ``{ .compatible = "rockchip,rk3328-efuse" },`` to file`` drivers/misc/rockchip-efuse.c`` because otherwise it will not Boot and hang. EFUSE - mac address will be always the same between boards.
